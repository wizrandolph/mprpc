...
class GetFriendListResponse :
 ...
 public:
  ...
  // repeated .testproto.User friend_list = 2;
  int friend_list_size() const;
  private:
  int _internal_friend_list_size() const;
  public:
  void clear_friend_list();
  ::testproto::User* mutable_friend_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::testproto::User >*
      mutable_friend_list();
  private:
  const ::testproto::User& _internal_friend_list(int index) const;
  ::testproto::User* _internal_add_friend_list();
  public:
  const ::testproto::User& friend_list(int index) const;
  ::testproto::User* add_friend_list();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::testproto::User > friend_list_;
  ::testproto::ResultCode* result_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListRequest::uid() const {
  // @@protoc_insertion_point(field_get:testproto.GetFriendListRequest.uid)
...
inline void GetFriendListRequest::set_uid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:testproto.GetFriendListRequest.uid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 User::_internal_uid() const {
  return uid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 User::uid() const {
  // @@protoc_insertion_point(field_get:testproto.User.uid)
  return _internal_uid();
}
inline void User::_internal_set_uid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  uid_ = value;
}
inline void User::set_uid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_uid(value);
  // @@protoc_insertion_point(field_set:testproto.User.uid)
}
...
inline ::testproto::User* GetFriendListResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:testproto.GetFriendListResponse.friend_list)
...
GetFriendListResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:testproto.GetFriendListResponse.friend_list)
  return &friend_list_;
}
inline const ::testproto::User& GetFriendListResponse::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::testproto::User& GetFriendListResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:testproto.GetFriendListResponse.friend_list)
  return _internal_friend_list(index);
}
inline ::testproto::User* GetFriendListResponse::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::testproto::User* GetFriendListResponse::add_friend_list() {
  // @@protoc_insertion_point(field_add:testproto.GetFriendListResponse.friend_list)
...
GetFriendListResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:testproto.GetFriendListResponse.friend_list)
  return friend_list_;
}
